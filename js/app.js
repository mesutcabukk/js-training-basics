...
// 07
{
  var a = "A";
  var c = "AC";
  var processed = "B" + a + c ;  // correct this!
...
// 13
{
  var c = 1;
  var a = 1;
  var processed =  String(c) + String(a);  // correct this!
...
// 15
{
  var processed = 'abcde';  // correct this!
...
// 20
{
  var c = "itclub";
  var b = "lub";
  var processed = c.substr(3); // correct this!
...
// 23
{
  var c = ["it", "club", "schweiz", "mesut"]; // correct this!
  isEqual(4, c.length);
}
// 24
{
...
// 25 
{
  var c = ["it", "blub", "blub", "club", "schweiz"]; // correct this!
  var processed = c; // correct this! check array functions
...
// 27
{
  ...
  var processed = c.join(",");
   processed.push("MUSTAFA");
    processed.splice(1,1);
